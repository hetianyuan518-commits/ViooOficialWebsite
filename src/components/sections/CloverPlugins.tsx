    ...
    <section id="clover" className="py-28 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div ref={ref} className="mb-16">
          ...
          >
            {/* Background glow */}
            <div className="absolute top-0 right-0 w-96 h-96 bg-clover-500/10 rounded-full blur-3xl gpu-layer" />
            <div className="absolute bottom-0 left-0 w-72 h-72 bg-brand-500/10 rounded-full blur-3xl gpu-layer" />
